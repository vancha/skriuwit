...
pub enum Message {
    ...
    LaunchUrl(String),
    ChooseFile,
    TagSelected(cosmic::widget::segmented_button::Entity),
...
impl cosmic::Application for AppModel {
    ...
    fn update(&mut self, message: Self::Message) -> Task<cosmic::Action<Self::Message>> {
        match message {
            ...
            Message::TagSelected(tag_id) => {
                println!("Tag selected: {:?}",tag_id);
            }
    ...
    fn on_nav_select(&mut self, id: nav_bar::Id) -> Task<cosmic::Action<Self::Message>> {
        ...
        //Task::none()
         Task::done(cosmic::Action::App(Message::TagSelected(id)))
    }
}
